...
public class AmbulanceFragment extends Fragment implements LongRunningOperationDelegate {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_ambulance, container, false);
    ...
    public void onResume() {
        ...
        System.out.println("lat:-" + lat);
            ...
            String placeCategory = "emergency,ambulance";
