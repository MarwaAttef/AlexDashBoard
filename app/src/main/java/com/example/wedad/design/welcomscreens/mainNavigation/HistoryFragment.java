...
import com.example.wedad.design.welcomscreens.adapter.HistoryAdapter;
...
public class HistoryFragment extends Fragment implements NotifyChange {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        img.setImageResource(R.drawable.historyempty);
    ...
    void HandleBetween() {
        ...
        places = db.getDataFromHistoryDB();
        if (places != null && places.size() != 0) {
            img.setVisibility(View.INVISIBLE);
            HistoryAdapter placeAdapter = new HistoryAdapter(getContext(), places);
            ...
            recyclerView.setAdapter(new HistoryAdapter(places, new HistoryAdapter.OnItemClickListener() {
                @Override
    ...
    public void notifyUi() {
        Fragment f=HistoryFragment.newInstance();
        beginTransaction(f);
    }
