...
public class AllFood extends Fragment implements LongRunningOperationDelegate {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_all_food, container, false);
