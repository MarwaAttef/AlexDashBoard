package com.example.wedad.design.welcomscreens.religionpkg;
...
public class ChurchFragment extends Fragment implements LongRunningOperationDelegate {
    double lat, log;
    String url;
    ...
    public void onResume() {
        ...
        System.out.println("lat:-" + lat);
            ...
            String placeCategory = "church";
            url = "https://maps.googleapis.com/maps/api/place/search/json?&location=" + lat + "," + log + "&radius=2000&sensor=false&key=" + apikey + "&type=" + "church";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_church, container, false);
