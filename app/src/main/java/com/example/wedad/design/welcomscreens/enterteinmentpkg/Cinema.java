...
public class Cinema extends Fragment implements LongRunningOperationDelegate {
    double lat, log;
    String url;
    ...
    public static Cinema newInstance(String param1, String param2) {
