package com.example.wedad.design.welcomscreens.attractionpkg;
...
import com.example.wedad.design.welcomscreens.adapter.Communicator;
...
public class AttractiveActivity extends AppCompatActivity implements LongRunningOperationDelegate {
    double lat, log;
    String url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attractive);
        getSupportActionBar().setElevation(0);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true); //<< this
        getSupportActionBar().setTitle("Attractions");  // provide compatibility to all the versions
