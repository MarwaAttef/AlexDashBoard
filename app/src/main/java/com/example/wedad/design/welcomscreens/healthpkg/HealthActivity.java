...
public class HealthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Health");  // provide compatibility to all the versions
        ...
        //////-------------------------------------- add to tab--------------------------------------///
        mTabHost.addTab(
                mTabHost.newTabSpec("tab1").setIndicator(getTabIndicator(mTabHost.getContext(), "Hospital")),
                HospitalFragment.class, null);


        ///
        mTabHost.addTab(
                mTabHost.newTabSpec("tab2").setIndicator(getTabIndicator(mTabHost.getContext(), "Pharmacy")),
                Pharmacy.class, null);
    }
